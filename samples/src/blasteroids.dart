...
class AttractorScene extends Scene {
  ...
  List actors = null;
  static const SCENE_LENGTH = 400;
  static const SCENE_FADE = 75;
...
class TextIndicator extends EffectActor {
  ...
  static const DEFAULT_FADE_LENGTH = 500;
...
class Asteroid extends EnemyActor {
  ...
  static const ANIMATION_LENGTH = 180;
...
class EnemyShip extends EnemyActor {
 ...
 static const SHIP_ANIM_LENGTH = 90;
 int _radius;
...
class Bullet extends ShortLivedActor {
  ...
  static const BULLET_WIDTH = 2;
  static const BULLET_HEIGHT = 6;
  static const FADE_LENGTH = 200;
...
class Bomb extends Bullet {
  ...
  static const BOMB_RADIUS = 4.0;
  static const FADE_LENGTH = 200;
  static const EFFECT_RADIUS = 45;
...
class EnemyBullet extends Bullet {
  ...
  static const BULLET_RADIUS = 4.0;
  static const FADE_LENGTH = 200;
...
class Player extends SpriteActor {
  ...
  static const MAX_PLAYER_VELOCITY = 8.0;
  static const PLAYER_RADIUS = 9;
  static const SHIELD_RADIUS = 14;
  static const SHIELD_ANIM_LENGTH = 100;
  static const SHIELD_MIN_PULSE = 20;
  static const ENERGY_INIT = 400;
  static const THRUST_DELAY_MS = 100;
  static const BOMB_RECHARGE_MS = 800;
  static const BOMB_ENERGY = 80;
