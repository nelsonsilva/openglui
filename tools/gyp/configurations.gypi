...

{
  'variables': {
    ...
    'target_arch%': 'ia32',
    'dart_target_arch%': 'IA32',
  },
  # target_arch is used to set the value of dart_target_arch. This 'conditions'
  # section must not go in the 'variables' scope above because, according to the
  # gyp spec: "A user-defined variable may be defined in terms of other
  # variables, but not other variables that have definitions provided in the
  # same scope."
  'conditions': [
  ...
  'conditions': [
    ...
    [ 'OS=="linux"', { 'includes': [ '../../third_party/dart/tools/gyp/configurations_make.gypi', ], } ],
    [ 'OS=="mac"', { 'includes': [ '../../third_party/dart/tools/gyp/configurations_xcode.gypi', ], } ],
    [ 'OS=="win"', { 'includes': [ '../../third_party/dart/tools/gyp/configurations_msvs.gypi', ], } ],
  ],
  'target_defaults': {
