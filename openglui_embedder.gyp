{
  ...
  'variables': {
    ...
    'skia_libs_location_android': '-Lthird_party/skia/out/config/android-x86/Release/obj.target/gyp', 
        ...
        'targets': [
          {
            ...
            'dependencies': [
              'skia-android',
              '<(dart)/dart.gyp:libdart_lib_withcore',
              '<(dart)/dart.gyp:libdart_vm',
              '<(dart)/dart.gyp:libjscre',
              '<(dart)/dart.gyp:libdouble_conversion'
            ],
            'include_dirs': [
              '<(dart)/runtime',
              '<(dart)/third_party/android_tools/ndk/sources/android/native_app_glue',
            ...
            'sources': [
              ...
              '<(dart)/third_party/android_tools/ndk/sources/android/native_app_glue/android_native_app_glue.h',
              '<(dart)/third_party/android_tools/ndk/sources/android/native_app_glue/android_native_app_glue.c',
